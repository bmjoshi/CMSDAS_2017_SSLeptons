...
//load the files we are using
  ...
  TFile *fbkg2 = new TFile("bg_chargeMisID.root");
  TFile *fsig1 = new TFile("bg_chargeMisID.root");
...
//initialize the canvas
  TCanvas *c1 = new TCanvas("c1","SS Can",10,10,600,1000);
//draw everything
  stackSSbkg->Draw();
...
//setup and draw the legend
  ...
  leg->AddEntry(histSSbkg1,"Background 1","f");
  leg->AddEntry(histSSbkg2,"Background 2","f");
  leg->Draw();
}
