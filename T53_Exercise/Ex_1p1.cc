...
void Ex_1p1(){
  ...
  //define cuts
  string masscuts = "(76 < diElMass_DileptonCalc) && (diElMass_DileptonCalc < 106)";
  string SSmasscuts = "(76 < diElMass_DileptonCalc) && (diElMass_DileptonCalc < 106) && (elCharge1_DileptonCalc == elCharge2_DileptonCalc)";
